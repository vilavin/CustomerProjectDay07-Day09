...
<form action="<c:url value='/customer'/>" method="post">
	...
	<tr>
		...
		<td>
			<input type="radio" name="gender" value="男" id="male"
				   <c:if test="${customer.gender=='男'}">checked</c:if>/>
			<label for="male">男</label>
			<input type="radio" name="gender" value="女" id="female"
				   <c:if test="${customer.gender=='女'}">checked</c:if>/>
	...
	<tr>
		<td>客户生日</td>
		<td>
			<input type="text" name="birthday" id="birthday" value="${customer.birthday}" readonly="readonly"/>
		</td>
		<td>
